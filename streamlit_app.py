...
if apply:
    ...
    fig7 = px.scatter(filtered_df, x='Rating', y='Voting Counts', size='Duration', color='Genre', hover_data=['Movie Name'])
    st.plotly_chart(fig7, use_container_width=True)

else:
    st.info("👈 Use the sidebar filters and click **Apply Filters** to view data and visualizations.")
